...
import (
	...
	"github.com/immon/revel/harness"
	"github.com/immon/revel/modules/testrunner/app/controllers"
	"io"
	"io/ioutil"
	"net/http"
	"os"
...
For example, to run the booking sample application's tests:
    ...
    revel test github.com/immon/revel/samples/booking dev
...
func testApp(args []string) {
	...
	for _, module := range revel.Modules {
		if module.ImportPath == "github.com/immon/revel/modules/testrunner" {
...
You can add it to a run mode configuration with the following line:
	...
	module.testrunner = github.com/immon/revel/modules/testrunner
